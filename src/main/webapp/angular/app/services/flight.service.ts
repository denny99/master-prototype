...
export class FlightService {
     ...
     */
    async getFlights(city: string, limit: number, offset: number,
                     sortOrder: string): Promise<ApiSearchResponse<Flight>> {

        const params = new HttpParams().append('city', city).append('limit', limit.toString()).append('offset', offset.toString()).append('sortOrder', sortOrder);
