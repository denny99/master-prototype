...
export class PassengerService {
     ...
     */
    async getPassengers(passportNumber: string, idCardNumber: string): Promise<Array<Passenger>> {
        // do ajax call
        const params = new HttpParams().append('passportNumber', passportNumber).append('idCardNumber', idCardNumber);
